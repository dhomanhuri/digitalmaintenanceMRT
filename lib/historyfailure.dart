...
class historyfailure extends StatefulWidget {
  static const String routeName = '/failure';

  @override
  State<historyfailure> createState() => _historyfailureState();
}

class _historyfailureState extends State<historyfailure> {
  ...
  Future<void> _failure() async {
    ...
    var resp = await http.get(Uri.parse(url + "/historyfailure/get"), headers: {
      'Cookie': _cookies,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:
            _isSearching ? _buildSearchField() : Text('Corrective Maintenance'),
