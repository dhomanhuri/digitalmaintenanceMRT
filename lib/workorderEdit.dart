...
class WorkorderEdit extends StatefulWidget {
  ...
  @override
  State<WorkorderEdit> createState() => _WorkorderEditState();
}
...
class _WorkorderEditState extends State<WorkorderEdit> {
  ...
  String selectperiod = globals.workorderperiodtemp;
  ...
  String _cookies = '';
  String title = '';
  String desc = globals.workorderdescriptiontemp;
  String location = '';
  String area = '';
  String delay = '';
  String reportedby = '';
  String receivedby = globals.workorderdepartmentidtemp;
  String failuredate = '';
  String failuretime = '';
  String system = '';
  String subsystem = '';
  ...
  String WoNumber = '';
  int status = 1;
  String reportdate = globals.workorderstartdatetemp;
  String note = '';
  ...
  Future<void> _addMaterial(String a) async {
    ...
    var request = http.MultipartRequest(
        'POST',
        Uri.parse(
            'http://147.139.134.143/mrtjakarta/public/api/workorder/save/' +
                globals.workorderidtemp));
              ...
              child: Form(
                ...
                child: Container(
                    ...
                    child: Column(
                      children: [
                        TextFormField(
                          initialValue: globals.workordernotemp,
                        ...
                        TextFormField(
                          initialValue: globals.workorderdescriptiontemp,
                          keyboardType: TextInputType.text,
                          decoration: const InputDecoration(
                        ...
                        Center(
                          child: DropdownSearch<String>(
                            ...
                            label: "Department",
                            selectedItem: globals.workorderdepartmenttemp,
                        ...
                        Padding(
                          ...
                          child: Center(
                            child: DropdownSearch<String>(
                              mode: Mode.BOTTOM_SHEET,
                              selectedItem: globals.workorderperiodtemp,
                              items: periodname,
                              label: "Period",
                              // hint: "country in menu mode",
                              onChanged: (value) {
