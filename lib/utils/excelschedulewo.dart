...
Future<void> createExcel(List<dynamic> data) async {
  ...
  sheet.getRangeByName('D5').columnWidth = 40;
  sheet.getRangeByName('B5').columnWidth = 10;

  sheet.getRangeByName('D5').setText('Description');
  sheet.getRangeByName('D5').cellStyle.fontSize = 12;

  sheet.getRangeByName('E5').setText('Period');
  sheet.getRangeByName('E5').cellStyle.fontSize = 12;
  // sheet.getRangeByName('E5').cellStyle

  sheet.getRangeByName('F5').setText('Start Date');
  ...
  for (int i = 0; i < data.length; i++) {
    ...
    sheet
        ...
        .setText(data[i]['description'].toString());
    sheet
        .getRangeByName('E' + (i + 6).toString())
        .setText(data[i]['period'].toString());
    sheet
        .getRangeByName('F' + (i + 6).toString())
        .setText(data[i]['start_date'].toString());
  }
