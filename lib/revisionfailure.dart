...
class revisionfailure extends StatefulWidget {
  static const String routeName = '/failureAdd';

  @override
  State<revisionfailure> createState() => _revisionfailureState();
}

class _revisionfailureState extends State<revisionfailure> {
  ...
  Future<void> _addMaterial(String a) async {
    ...
    var request = http.MultipartRequest(
        'POST',
        Uri.parse(
            'http://147.139.134.143/mrtjakarta/public/api/failureclose/status/5/' +
                      ...
                      children: [
                        TextFormField(
                          ...
                          decoration: const InputDecoration(
                            hintText: 'Need Revision',
                            labelText: 'Need Revision',
                          ),
                          validator: (value) {
                            if (value!.isEmpty)
                              return 'Need Revision tidak boleh kosong';
