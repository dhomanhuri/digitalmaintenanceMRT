...
class _unitEditState extends State<unitEdit> {
  ...
  String _tokenJwt = '';
  String _cookies = '';
  String title = globals.unitnametemp;
  String location = '';
  String initialtitle = '';
  String initialqty = '';
  String reportedby = '';
  ...
  //   });
  //   setState(() {
  //     _getsearchmat = jsonDecode(resp.body);
  //     for (var i = 0; i < _getsearchmat.length; i++) {
  //       print('cari: ' +
  //           _getsearchmat[i]['name'] +
  //           ' caa' +
  //           globals.materialidtemp.toString());
  //       if (_getsearchmat[i]['id'].toString() ==
  //           globals.materialidtemp.toString()) {
  //         initialtitle = _getsearchmat[i]['name'];
  //         initialqty = _getsearchmat[i]['quantity'].toString();
  //         title = _getsearchmat[i]['name'];
  //         qty = _getsearchmat[i]['quantity'].toString();
  //         print('ketemu');
  //         break;
  //       }
  //     }
  ...
  Future<void> _addMaterial(String a) async {
    ...
    var request = http.MultipartRequest(
        'POST',
        Uri.parse('http://147.139.134.143/mrtjakarta/public/api/unit/save/' +
