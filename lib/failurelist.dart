...
class failurelist extends StatefulWidget {
  static const String routeName = '/failure';

  @override
  State<failurelist> createState() => _failurelistState();
}

String _tokenJwt = '';
String _cookies = '';

class _failurelistState extends State<failurelist> {
  ...
  Future<void> _subsystem1() async {
    ...
    var request = http.Request(
        'GET',
        Uri.parse(
            'http://147.139.134.143/mrtjakarta/public/api/systemsub/get'));
    request.bodyFields = {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: _isSearching ? _buildSearchField() : Text('Failure List'),
